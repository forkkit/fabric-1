...
func (m *SessionRequest) GetIdentity() string {
	if m != nil {
		return m.Identity
	}
	return ""
...
type CreateTerminatorRequest struct {
	...
	IdentitySecret       string               `protobuf:"bytes,9,opt,name=identitySecret,proto3" json:"identitySecret,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *CreateTerminatorRequest) GetIdentitySecret() string {
	if m != nil {
...
var fileDescriptor_a0572e205f89e843 = []byte{
	...
	,
}
